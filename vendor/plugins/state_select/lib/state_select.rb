...
module Helpers #:nodoc:
  ...
  module FormOptionsHelper
    ...
    def state_options_for_select(selected = nil, country = "")
      if country.blank?
        grouped_states = [["Other", ["(Other / Unlisted)"]]]
        ["US", "Australia", "Canada", "France", "Germany", "India", "Ireland", "Scotland", "Spain", "Uganda", "UK", "Wales"].each do |country|
          grouped_states += [[country, States.const_get(country.upcase)]]
        end
        grouped_options_for_select(grouped_states, selected)
      else
